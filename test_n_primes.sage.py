...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_113038384112950627112915298112892539 = Integer(113038384112950627112915298112892539); _sage_const_0 = Integer(0); _sage_const_342 = Integer(342); _sage_const_6 = Integer(6); _sage_const_10000 = Integer(10000); _sage_const_100 = Integer(100); _sage_const_50000 = Integer(50000); _sage_const_4 = Integer(4); _sage_const_500 = Integer(500); _sage_const_ = Integer(); _sage_const_4000 = Integer(4000); _sage_const_500000 = Integer(500000); _sage_const_10 = Integer(10); _sage_const_1000 = Integer(1000); _sage_const_2000 = Integer(2000); _sage_const_1000000 = Integer(1000000); _sage_const_100000 = Integer(100000); _sage_const_1 = Integer(1); _sage_const_3000 = Integer(3000)
import time
...
def main():
    ns_primes = [_sage_const_500 , _sage_const_1000 , _sage_const_2000 , _sage_const_3000 , _sage_const_4000 ,_sage_const_10000 ,_sage_const_50000 ,_sage_const_100000 ,_sage_const_500000 ,_sage_const_1000000 ]
    n_factored = _sage_const_6 
    n_epochs = _sage_const_4 
    ...
    t_args = [(i, n, n_epochs, _sage_const_4 , len(ns_primes)) for (i, n) in enumerate(ns_primes)]
